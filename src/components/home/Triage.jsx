...
const ITEMS = [
  { to: '/safety', icon: Siren, t: 'Aku lagi susah sekarang', d: 'Butuh bantuan segera? Buka halaman darurat.', color: '#f1487c', bg: '#feedf2' },
  { to: '/articles', icon: BookOpen, t: 'Aku mau cari info', d: 'Baca materi psikoedukasi tentang apa yang kamu rasakan.', color: '#3899fe', bg: '#ebf3ff' },
  { to: '/bantu-teman', icon: HeartHandshake, t: 'Aku khawatir sama temanku', d: 'Cara mendampingi orang yang kamu sayangi.', color: '#40ae87', bg: '#e1fbfa' },
]
